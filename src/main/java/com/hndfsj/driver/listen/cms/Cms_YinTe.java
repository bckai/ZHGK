...
public class Cms_YinTe extends HDBaseDriver {
	
	static Logger log=LoggerFactory.getLogger(Cms_YinTe.class);
	...
	public void update(Observable o, Object arg) {
		...
		log.info("接收数据来自：汉威光电可变信息标志-" + this.dvcId + "-" + sr.spc.getPortName()
		...
		// 或者是处于发布节目等待执行结果的状态
			...
			pageRequest.addAndCondition(CmsStruct.DVC_ID, SearchCondition.EQUAL, this.dvcId);
	...
	public void send(Object obj) {
		...
		if (obj instanceof List<?>) {
			...
			super.sendHex(CmsFactory.HanWeiSendMsgs(msgs));
			// 标记为发布节目等待结果的状态
