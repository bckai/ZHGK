...
public abstract  class TcpClientServer{
	public TcpClientServer(){}
	static Logger log = LoggerFactory.getLogger(TcpClientServer.class);
	protected String dvcId;
	protected static OutputStream out = null; // 写
	...
	static {
		try {
			...
			try {
				socket.connect(new InetSocketAddress("10.141.151.150", Integer.parseInt("4001")), 3000);
