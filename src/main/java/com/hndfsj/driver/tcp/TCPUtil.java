...
public class TCPUtil {
	 ...
	 */
	public static String sendTCPRequest(String IP, String port, String reqData){
		...
		try {
			...
			if (null!=socket && socket.isConnected() && !socket.isClosed()) {
				try {
					socket.close();
					System.out.println("关闭客户机Socket");
				} catch (IOException e) {
	...
	public static void main(String[] args) {  
	    ...
	    System.out.println(sendTCPRequest(IP, port, reqData));  
	} 
