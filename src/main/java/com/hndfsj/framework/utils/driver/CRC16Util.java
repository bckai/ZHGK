...
public class CRC16Util {
	...
	/**
	 * 对 16 进制串进行 CRC-16 校验，返回校验码
	 * 
	 * @param hexStr
	 * @return String CRC-16 校验码
	 */
	public static String caluCRC16(String hexStr) {
		byte[] pByte = new byte[hexStr.length() / 2];
		for (int i = 0; i < hexStr.length() / 2; ++i)
			pByte[i] = (byte) (Integer.parseInt(
					hexStr.substring(i * 2, i * 2 + 2), 16) & 0xff);
