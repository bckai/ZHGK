 ...
 * @see com.hndfsj.framework.base.controller.BaseRestJSONController
 * 
 * @param <Entity>
 * @param <PK>
 */
public class BaseRestJSONController<Entity, PK> {
	...
	@RequestMapping("/save")
	public @ResponseBody
	MReturnObject create(Model model, Entity entity, HttpServletRequest request,
	...
	public @ResponseBody
	MReturnObject destroy(@PathVariable String id) {
		throw new UnsupportedOperationException("not implement");
	}
...
//	public @ResponseBody MReturnObject edit(@PathVariable("id") PK id) {
//		throw new UnsupportedOperationException("not implement");
//	}
	...
	public @ResponseBody MReturnObject show(@PathVariable("id") PK id) {
		throw new UnsupportedOperationException("not implement");
	}
	...
	public @ResponseBody
	MReturnObject update(@PathVariable("id") PK id, Entity entity) {
		throw new UnsupportedOperationException("not implement");
	}
	...
	public @ResponseBody
	MReturnObject destroyId(@PathVariable("id") PK id) {
		throw new UnsupportedOperationException("not implement");
	}
...
//	public String _new(HttpServletRequest request, Model model) {
//		throw new UnsupportedOperationException("not implement");
//	}
	...
	public @ResponseBody MReturnObject create(Entity entity, HttpServletRequest request,  Model model) {
		throw new UnsupportedOperationException("not implement");
	}
