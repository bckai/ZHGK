<#include "../../common/meta.ftl">
	...
	<script type="text/javascript">
	   ...
	   function doSerach(){
	      location.href = "${ctx.contextPath}/rest/member/page/list?userName="+$('#userName').val()+"&deptId="+
	...
	<!-- 查询 -->
		 ...
		 <dt>    	
		    		<div>人员列表</div>
	    			<a class="a_3" href="#" onclick="location.href='${ctx.contextPath}/rest/member/post/pre'">添加</a>
	     </dt>
	    		<dd>
				<table class="tb_2">
		        	<tr>
		            ...
		            <#list page.data as user>		
		                <tr>
			                ...
			                <td align="center" width="300">
				                <a href="${ctx.contextPath}/rest/member/${user.id}/modifyMember">修改</a>
								/ <a href="${ctx.contextPath}/rest/member/${user.id}/role/assign/post/pre">分配角色</a>
								/ <a href="#" onclick="deleteUser('${user.id}')">删除</a>
								/ <a href="#" onclick="resetPWD('${user.id}')">密码重置</a>
							</td>
		            	</tr>
